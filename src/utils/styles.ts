...
export const buttonStyles = {
  primary: 'bg-black hover:bg-white text-white hover:text-black border border-black transition-all duration-300',
  secondary: 'text-gray-900 border border-black hover:bg-black hover:text-white transition-all duration-300',
  sizes: {
