...
export const businessLocations: LocalBusiness[] = [
  ...
  },
  {
    ...
    email: 'toulouse@sidikoff.digital',
    openingHours: [
      'Monday 09:00-18:00',
      'Tuesday 09:00-18:00',
      'Wednesday 09:00-18:00',
...
export function generateLocalBusinessSchema(location: LocalBusiness) {
  return {
    ...
    '@type': 'LocalBusiness',
    '@id': `https://sidikoff.digital/#business-${location.address.addressLocality.toLowerCase()}`,
    name: location.name,
    alternateName: 'SIDIKOFF DIGITAL',
    description: location.description,
    url: 'https://sidikoff.digital',
    logo: 'https://sidikoff.digital/images/logo-sidikoff.svg',
    image: [
      'https://sidikoff.digital/images/about/team-workspace.jpg',
      'https://sidikoff.digital/images/about/innovation.jpg',
    ],
    address: {
      '@type': 'PostalAddress',
...
export const organizationSchema = {
  ...
  logo: {
    '@type': 'ImageObject',
    url: 'https://sidikoff.digital/images/logo-sidikoff.svg',
    width: 300,
    height: 100,
  },
  image: 'https://sidikoff.digital/images/about/team-workspace.jpg',
  founder: {
    '@type': 'Person',
