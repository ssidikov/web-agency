      ...
      <div className='relative z-10 container mx-auto px-4 text-center'>
        <div className='max-w-5xl mx-auto'>
          ...
          <motion.div
            ...
            className='inline-flex items-center px-4 py-2 rounded-full text-sm font-medium mb-8 bg-white/10 text-black/50 border border-black/20 backdrop-blur-sm mt-24 sm:mt-28 md:mt-32'>
