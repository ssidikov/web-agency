              ...
              <div className="bg-white rounded-3xl border border-gray-100 shadow-2xl shadow-gray-900/5 p-10 h-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="group">
                      <label htmlFor="name" className="block text-sm font-semibold text-gray-700 mb-3 group-focus-within:text-black transition-colors">
                    ...
                    <div className="group">
                      <label htmlFor="email" className="block text-sm font-semibold text-gray-700 mb-3 group-focus-within:text-black transition-colors">
                  ...
                  <div className="group">
                    <label htmlFor="message" className="block text-sm font-semibold text-gray-700 mb-3 group-focus-within:text-black transition-colors">
                  ...
                  {submitStatus === 'success' && (
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <p className="text-green-800 font-medium">{dictionary.contact.form.success}</p>
                      </div>
                    </motion.div>
                  )}
                ...
                <div className="grid grid-cols-2 gap-4">
                  {contactData.channels.map((channel, index) => {
                    ...
                    return (
                      ...
                      >
                        <Icon size={32} className="mb-3 text-gray-700 group-hover:text-white transition-colors duration-300" />
                        <span className="font-semibold text-sm text-gray-900 group-hover:text-white transition-colors duration-300">{channel.name}</span>
                    ...
                    return (
                      ...
                      >
                        <div className="flex-shrink-0 w-12 h-12 bg-gray-100 group-hover:bg-black rounded-2xl flex items-center justify-center transition-colors duration-300">
                          <Icon size={20} className="text-gray-600 group-hover:text-white transition-colors duration-300" />
                        </div>
                  ...
                  {contactData.socialLinks.map((social, index) => {
                    ...
                    return (
                      <motion.a
                        ...
                        transition={{ delay: index * 0.1 }}
                      >
                        <Icon size={24} className="text-gray-300 group-hover:text-black transition-colors duration-300" />
                      </motion.a>
                    )
                  })}
                </div>
