...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Pages locales SEO (français uniquement pour SEO local)
  const localPages = [
      ...
      sitemap.push({
        ...
        alternates: {
          languages: {
            ...
            ru: page.path ? `${baseUrl}/ru/${page.path}` : `${baseUrl}/ru`,
            'x-default': page.path ? `${baseUrl}/fr/${page.path}` : `${baseUrl}/fr`,
          },
        },
      })
    })
