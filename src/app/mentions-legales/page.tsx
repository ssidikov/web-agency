...
export default async function MentionsLegalesPage() {
  // Используем французский язык по умолчанию для этой страницы
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <a href={`tel:${dict.legal.phone}`} className="text-lg text-[#112D4E] font-medium hover:text-[#3F72AF] transition-colors">
                      {dict.legal.phone}
                    </a>
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <a href={`mailto:${dict.legal.email}`} className="text-lg text-[#112D4E] font-medium hover:text-[#3F72AF] transition-colors">
                      {dict.legal.email}
                    </a>
                  </div>
                </div>
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/30">
              ...
              <p className="text-lg text-[#112D4E] font-medium">
                {dict.legal.director_name}
              </p>
            </section>
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/30">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col">
                  ...
                  <a href={`https://${dict.legal.host_website}`} target="_blank" rel="noopener noreferrer" className="text-lg text-[#112D4E] font-medium hover:text-[#3F72AF] transition-colors">
          ...
          <div className="mt-16 text-center">
            <Link href="/" className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#3F72AF] to-[#112D4E] text-white font-semibold rounded-full hover:shadow-lg transition-all duration-300 hover:scale-105">
              ← Retour à l&apos;accueil
            </Link>
          </div>
        </div>
