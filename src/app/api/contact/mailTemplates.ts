...
const translations = {
  ...
  en: {
    ...
    userMessage:
      'We have received your request. Our team will contact you shortly to discuss it.',
    ...
    <body style="margin: 0; padding: 20px; background-color: #f3f4f6; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
      ...
      <div class="email-container">
        ...
        <div class="email-header">
          <img src="https://sidikoff.com/logo-sidikoff.webp" alt="Sidikoff Digital" class="logo">
